About lancet-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lancet-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/ioam/lancet

Documentation: https://ioam.github.io/param/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5923&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lancet-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lancet` can be installed with `conda`:
...
```
mamba install lancet
```

It is possible to list all of the versions of `lancet` available on your platform with `conda`:
...
```
mamba search lancet --channel conda-forge
```
...
mamba repoquery search lancet --channel conda-forge

# List packages depending on `lancet`:
mamba repoquery whoneeds lancet --channel conda-forge

# List dependencies of `lancet`:
mamba repoquery depends lancet --channel conda-forge
```
